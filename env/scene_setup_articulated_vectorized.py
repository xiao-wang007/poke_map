...
L_COLLISION_APPROXIMATION = SCENE_CONFIG["l_collision_approximation"]
CYLINDER_COLLISION_APPROXIMATION = SCENE_CONFIG["cylinder_collision_approximation"]

NUM_ENVS = SCENE_CONFIG["num_envs"]
ENV_SPACING = SCENE_CONFIG["env_spacing"]
ENVS_ROOT_PATH = SCENE_CONFIG["envs_root_path"]
SOURCE_ENV_PATH = f"{ENVS_ROOT_PATH}/{SCENE_CONFIG['source_env_name']}"
...
L_OBJECT_LOCAL_POSITION = SCENE_CONFIG["l_object_local_position"]
...
DELAY_TO_SETTLE = SCENE_CONFIG["settle_steps"]
